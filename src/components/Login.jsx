  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://localhost:5000/api/auth/login", {
      ...
      headers: {
        ...
        // "auth-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjY1NmZhM2U5MDNlYzYyMjUwNWI5OGViIn0sImlhdCI6MTcxNzM5NDIzMCwiZXhwIjoxNzE3Mzk3ODMwfQ.93WnqxZFh_O6UmGHRKlPe2OoETjimHCouYasvyrbeYw"
      },
      body: JSON.stringify({
